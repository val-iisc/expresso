...
class Ui_Form(QtGui.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.scrollArea.setGeometry(QtCore.QRect(40, 59, 551, 311))
        self.scrollArea.setStyleSheet(_fromUtf8("background-color:rgb(210,225,210)"))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName(_fromUtf8("scrollArea"))
        self.scrollAreaWidgetContents = QtGui.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 549, 309))
